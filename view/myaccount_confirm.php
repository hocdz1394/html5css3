      ...
      <div class="bar-category-right">
        ...
        <div class="user-body">
          ...
          <div class="user-body-main">
            ...
            <h2 style="color:#75B70D; text-align:center; padding-top: 1rem">Thông tin đã được cập nhật</h2>
            <form action="index.php?pg=update" method="POST">
              <div class="profile-right">
               <div class="profile-right-input">
                <p>Tên</p>
                <input type="text"
                placeholder="Nhập tên" value="<?=$username?>" name="" id="">
               </div>
               <div class="profile-right-input">
                <p>Mật khẩu</p>
                <input type="password" value="<?=$password?>" 
                placeholder="Nhập mật khẩu"  name="" id="">
               </div>
              </div>
              <div class="profile-right-input ngaysinh ">
               <p>Số điện thoại</p>
               <input class="wh" type="text" value="<?=$phonenb?>"
               placeholder="Nhập số điện thoại" name="" id="">
              </div>
              <div class="ngaysinh">
               <p>Email</p>
              ...
              <div class="ngaysinh">
               <p>Địa chỉ</p>
               <input type="text" placeholder="Nhập địa chỉ" value="<?=$diachi?>" name="" id="">
              </div><br><br>
              </form>
            </div>
          </div>
